...
class JugadorControllerTests {
	...
	private static final int idPrueba =  1;
	@Autowired
	...
	void setup() {
		...
		given(this.jugadorService.findJugadorByUsername(USERNAME)).willReturn(george);
	...
	void testMostrarEstadisticas() throws Exception{
		mockMvc.perform(get("/jugador/{id}/estadisticas", idPrueba))

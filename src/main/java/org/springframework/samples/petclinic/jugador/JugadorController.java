...
public ModelAndView mostrarEstadisticas(@PathVariable("id") int id){
	...
	Jugador jugador = this.jugadorService.findJugadorById(id);
	Integer partidasJugadas = jugador.getNumPartidas();
	mav.addObject(jugador);
	mav.addObject("partidasJugadas", partidasJugadas);
	return mav;
}
